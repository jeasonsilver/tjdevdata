 ...
 * 最后修正：2010-6-29
 **/
var IMAGESPATH = '../pop/images/'; //图片路径配置，如在有iframe情况下使用，此路径为最顶层窗口页面的相对路径
...
Dialog.prototype.create = function () {
    ...
    var html = '\
  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" class="noborder" style="font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" onselectstart="return false;" style="display: none;-moz-user-select: -moz-none; ' + (this.Drag ? "cursor: move;" : "") + '">\
    ...
    <tr valign="top">\
      <td class="noborder"  width="13" style="background-image: url({IMAGESPATH}dialog_mlm.png) !important;background: url({IMAGESPATH}dialog_mlm.gif) repeat-y left;"></td>\
      <td class="noborder" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" class="noborder" bgcolor="#ffffff">\
          <tr id="_MessageRow_{thisID}" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" class="noborder" style="background:#eaece9 url({IMAGESPATH}dialog_bg.jpg) no-repeat scroll right top;" id="_MessageTable_{thisID}">\
                <tr>\
	...
	' + (function (obj) {
        ...
        if (obj.URL) return '<iframe width="100%" height="125" frameborder="0" style="border:none 0;" id="_DialogFrame_' + obj.ID + '" ' + (obj.InnerFrameName?'name="'+obj.InnerFrameName+'"':'')+' src="' + obj.displacePath() + '"></iframe>';
        return "";
    })(this) + '\
              </div></td>\
          </tr>\
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:9pt;color:#000000">' + msg + '</td></tr>\
	</table>';
    diag.show();
...
for(var i=0;i<scripts.length;i++){
	...
	if(/.*zDialog2\.js$/g.test(scripts[i].getAttribute("src"))){
		var jsPath = scripts[i].getAttribute("src").replace(/zDialog2\.js$/g,'');
