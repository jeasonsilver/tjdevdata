	...
	<script type="text/javascript">
		...
		$(function(){
							...
							$.ajax(
									{
							      		   ...
							      		   error:Free.ajaxError,
							       		   success: function(data){
							       	     	if(data=='ok'){
							       	     		alert("保存成功");
							       	     		location.href="${ctx}/dblz/lzjycg/lzjycg_list_hz.do?free_menuTitleName=履职信息汇总";
							       	     	}
							       		}
							         }
							);
				...
				$('#file_upload').uploadify({  
	                ...
	                'uploader': '${ctx}/dblz/lzjycg/ajax_upload.do', //服务器端脚本  
...
<form class="span12"  method="post" id="inputForm" action="${ctx}/dblz/lzjycg/save.do" >
	...
	<div class="row" style="margin-top: 10px">
		...
		<label class="span2 " for="" style="margin-top: 50px">履职体会<font color="red">*</font></label><div class="span10">
		...
		<div class="span12 text-center" style="margin-top: 20px;margin-bottom: 20px">		
			<button class="btn btn-success" id="free_submit" type="button" onclick="$('#file_upload').uploadify('upload', '*');"> 上传附件 </button>
